 ...
 *  Description :
 *  	Creates a custom list adapter for owner List Fragment, so more details could be shown in the list
 */
...
/**
 * Creates a custom list adapter for owner List Fragment, so more details could
...
public class OwnerListAdapter extends BaseAdapter {
	 ...
	 * 
	 */
	public OwnerListAdapter(Context context, List<SubjectDAO> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			vi = inflater.inflate(R.layout.list_row_owner, null);

			holder = new ViewHolder();
			// ownerName
			holder.keyOwnerName = (TextView) vi
					.findViewById(R.id.txtKeyOwnerName);
			// ownerDeviceID
			holder.keyOwnerDevice = (TextView) vi
		...
		holder.keyOwnerName.setText(subject.getName());
		holder.keyOwnerDevice.setText(context
	...
	static class ViewHolder {
		TextView keyOwnerName;
		TextView keyOwnerDevice;

 ...
 *  Description :
 *  	Creates a custom list adapter for a list of certificates, this
 * list shows:
 * <ul>
 * <li>Owner name
 * <li>Issuer name
...
/**
 * Creates a custom list adapter for a list of certificates, this list shows:
 * <ul>
 * <li>Owner name
 * <li>Issuer name
 * <li>DB status
...
public class CertificatesListAdapter extends BaseAdapter {
	 ...
	 */
	public CertificatesListAdapter(Context context, List<CertificateDAO> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			TextView txtTrustLevel = (TextView) vi.findViewById(R.id.txtTrustLevel);
			txtTrustLevel.setVisibility(View.GONE);
		...
		CertificateDAO cert = data.get(position);
	...
	protected void onClickSeeDetails(int position) {
		...
		int ownerId = data.get(position).getOwner().getId();
		int certId = data.get(position).getId();

 ...
 * @version 1.0
 */
public class OwnerWithCertificateSelectableListAdapter extends BaseAdapter {
	 ...
	 */
	public OwnerWithCertificateSelectableListAdapter(Context context, List<SubjectDAO> data,
			SparseArray<Integer> certificateCount) {
